                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.props.options.map(function (item) {
                            var itemCls = item.value === selectIndex ? 'selected' : '';
                            return _react2.default.createElement(
                                'li',
                                { key: item.value, className: '' + itemCls, onClick: _this2.itemClick.bind(_this2), value: item.value },
                                item.label
                            );
                        })
                    )
